...
CourseMenuDWRFacade.getCourseToolsByTypeAndFilter = function(p0, p1, p2, p3, callback) {
  dwr.engine._execute(CourseMenuDWRFacade._path, 'CourseMenuDWRFacade', 'getCourseToolsByTypeAndFilter', p0, p1, p2, p3, callback);
}
